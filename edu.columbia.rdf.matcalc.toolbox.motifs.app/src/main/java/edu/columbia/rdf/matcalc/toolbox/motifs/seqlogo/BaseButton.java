  ...
  public void drawForegroundAAText(Graphics2D g2) {
    ...
    if (color != null) {
      ...
      try {
         ...
         * Color c;
         * 
         * if (isSelected() || mHighlight || mPopupShown) { c =
         * ColorUtils.getTransparentColor40(color); } else { c = color; }
         */

        /*
         * getRenderer().fill(g2Temp, color, x, y, SIZE, SIZE);
         */
        ...
        /*
         * getRenderer().outline(g2Temp, color, x, y, Ribbon.COMPACT_ICON_SIZE,
