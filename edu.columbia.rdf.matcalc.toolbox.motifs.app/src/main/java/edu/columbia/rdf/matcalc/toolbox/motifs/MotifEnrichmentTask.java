...
public class MotifEnrichmentTask extends SwingWorker<Void, Void> {
	 ...
	 */
	public MotifEnrichmentTask(MainMatCalcWindow parent,
			List<Motif> motifs,
			MainMatCalcWindow foregroundGroup,
			MainMatCalcWindow backgroundGroup,
			double threshold,
	...
	public static DataFrame enrichmentMotifs(double threshold,
			...
			List<SearchSequence> foregroundSequences,
			List<SearchSequence> backgroundSequences) {
		List<SearchSequence> foregroundRevCompSeqs = 
				SearchSequence.reverseComplement(foregroundSequences);

		List<SearchSequence> backgroundRevCompSeqs = 
				SearchSequence.reverseComplement(backgroundSequences);
		...
		boolean[] goldStandard = MotifSearch.createGoldStandard(foregroundSequences.size(), 
