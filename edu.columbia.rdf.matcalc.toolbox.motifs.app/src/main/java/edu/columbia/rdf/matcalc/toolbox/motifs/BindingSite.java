...
public class BindingSite {
	...
	public BindingSite(String sequence, 
			int offset, 
			double score, 
			char strand) {
	...
	public String toString() {
		return new StringBuilder(mSequence).append(TextUtils.TAB_DELIMITER).append(mStrand).append(TextUtils.TAB_DELIMITER).append(Integer.toString(mOffset)).append(TextUtils.TAB_DELIMITER).append(Double.toString(mScore)).toString();
	}
	...
	public static List<BindingSite> sortByScore(List<BindingSite> sites) {
		Map<Double, List<BindingSite>> scoreMap = 
				new HashMap<Double, List<BindingSite>>();
	...
	public static List<BindingSite> sortByDistance(List<BindingSite> sites) {
		Map<Integer, List<BindingSite>> offsetMap = 
				new HashMap<Integer, List<BindingSite>>();
