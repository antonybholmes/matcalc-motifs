...
public class MotifSearchDialog extends ModernDialogHelpWindow {
	...
	private ModernButton mSettingsButton = new
			ModernButton(UIService.getInstance().loadIcon("settings", 16));
	...
	*/
	...
	public MotifSearchDialog(ModernWindow parent, 
			GroupsModel regionGroupsModel) {
	...
	private final void createUi() {
		...
		ModernScrollPane scrollPane = new ModernScrollPane(new FigurePanel(new Figure("Seq Logo Figure")
				.addSubFigure(mSubFigure)));
		...
		//panel.add(new ModernDialogHelpButton("Group", "The group of regions in which to search for motifs."));
		//panel.add(new ModernLabel("5' extension"));
		//panel.add(new ModernTextBorderPanel(mExt5pField));
		//panel.add(new ModernDialogHelpButton("5' Extension", "How much to extend the 5' search region relative to the feature orientation."));
		//panel.add(new ModernLabel("3' extension"));
		//panel.add(new ModernTextBorderPanel(mExt3pField));
		//panel.add(new ModernDialogHelpButton("3' Extension", "How much to extend the 3' search region relative to the feature orientation."));
		//panel.add(new ModernLabel("Motif threshold"));
		//panel.add(new ModernTextBorderPanel(mThresholdField));
		//panel.add(new ModernDialogHelpButton("Motif Threshold", "Motifs must score at least p * maxScore()."));	
		//box.add(panel);
